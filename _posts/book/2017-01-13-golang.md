...
A nice SVG is created using float64 calculations and fmt.Fprintf with this [code](https://github.com/4hel/golang/blob/master/chap03/b_exercise-3.3/surfacecol.go):
